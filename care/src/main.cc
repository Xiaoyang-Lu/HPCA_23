...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
	...
	<< "Core_" << cpu << "_" << cache->NAME << "_total_overlapped_cycles_per_core " << cache->total_overlapped_cycles_per_core[cpu] << endl
	<< "Core_" << cpu << "_" << cache->NAME << "_average_overlapped_cycles_per_access " << 1.0 * (cache->total_overlapped_cycles_per_core[cpu]) / TOTAL_ACCESS << endl
	<< endl;
